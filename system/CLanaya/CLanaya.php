...
class CLanaya implements ISingleton {
	...
	protected function __construct() {
    	...
    	// Get title
    	if(isset($this->config['theme']['data']['title'])) {
    		$this->title = $this->config['theme']['data']['title'];
    	}
  	}
	...
	public function ThemeEngineRender() {
		...
		$themePath  = LANAYA_INSTALL_PATH . '/' . $this->config['theme']['path'];
		...
		if(isset($this->config['theme']['parent'])) {
			$parentPath = LANAYA_INSTALL_PATH . '/' . $this->config['theme']['parent'];
		...
		include(LANAYA_INSTALL_PATH . '/views/functions.php');
	...
	public function DrawMenu($menu) {
		...
		if(isset($this->config['theme']['data']['favicon'])) {
			$items .= "<li><img src='" . $this->CreateUrl("public/img/" . $this->config['theme']['data']['favicon']) . "' width='" . $this->config['theme']['data']['logo_width'] . "' height='" . $this->config['theme']['data']['logo_height'] . "'></img></li>";
			$items .= "<li></li>";
		} else if (isset($this->config['theme']['data']['slogan'])){
			$items .= "<li><a href='" . $this->CreateUrl("") . "'>{$this->config['theme']['data']['slogan']}</a></li>";
			$items .= "<li></li>";
		}
		...
		if(isset($this->config['menus'][$menu])) {
			foreach($this->config['menus'][$menu] as $val) {
				$items .= "<li><a href='" . $this->CreateUrl($val['url']) . "'>{$val['label']}</a></li>";
			}
		} else {
