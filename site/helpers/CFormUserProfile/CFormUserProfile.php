...
class CFormUserProfile extends CForm {
	...
	public function __construct($object, $user) {
		...
		->AddElement(new CFormElementSubmit('change_password', array('callback'=>array($object, 'DoChangePassword'), 'class'=>'btn btn-primary')))
		...
		->AddElement(new CFormElementSubmit('save', array('callback'=>array($object, 'DoProfileSave'), 'class'=>'btn btn-primary')));
	}
